...
namespace Jogl.Server.ConversationCoordinator
{
    public abstract class BaseFunction
    {
        ...
        protected async Task<string> MirrorConversationAsync(string text)
        {
        ...
        protected async Task MirrorRepliesAsync(string mirrorConversationId, List<string> text)
        {
            var outputService = _outputServiceFactory.GetService(Const.TYPE_SLACK);
        ...
        protected async Task MirrorReplyAsync(string mirrorConversationId, string text)
        {
            await MirrorRepliesAsync(mirrorConversationId, [text]);
        }
    }
}
