...
//    private readonly ILogger<InfoBipWhatsappController> _logger;

//    public InfoBipWhatsappController(IAIService aiService, IInterfaceMessageRepository interfaceMessageRepository, ISystemValueRepository systemValueRepository, IWhatsAppService whatsAppService, IServiceBusProxy serviceBusProxy, ILogger<InfoBipWhatsappController> logger)
//    {
...
//    [HttpPost("webhook")]
//    // [ValidateRequest]
//    public async Task<IActionResult> ReceiveMessage([FromForm] InfoBipMessage payload)
//    {
...
//    private async Task SendNewConversation(InfoBipMessage payload)
//    {
//        var from = payload.From.Replace("whatsapp:", string.Empty);
...
//    private async Task SendReply(InfoBipMessage payload, InterfaceMessage message)
//    {
//        var from = payload.From.Replace("whatsapp:", string.Empty);
