...
//        private readonly IInfoBIPConversationService _infoBipConversationService;
//        private readonly ILogger<InfoBipWhatsappService> _logger;
//        public InfoBipWhatsappService(IConfiguration configuration, IInfoBIPConversationService infoBipConversationService, ILogger<InfoBipWhatsappService> logger)
//        {
//            _configuration = configuration;
//            _infoBipConversationService = infoBipConversationService;
//            _logger = logger;
//        }
...
//            {
//                var msgRes = await _infoBipConversationService.SendWhatsappMessageAsync(_configuration["InfoBip:Number"], number, chunk);
//                res.Add(msgRes, chunk);
//            }
...
//            //var res = await _infoBipConversationService.ListMessagesAsync();
