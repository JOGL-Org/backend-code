...
namespace Jogl.Server.Notifier.Discussion
{
    public class UserIndexFunction
    {
        ...
        public UserIndexFunction(IUserRepository userRepository, IDocumentRepository documentRepository, IPaperRepository paperRepository, Search.ISearchService searchService, ILogger<UserIndexFunction> logger)
        {
        ...
        public async Task Run([TimerTrigger("0 * * * * *")] TimerInfo myTimer)
        {
            ...
            await _searchService.IndexUsersAsync(users, documents, papers);
        }
    }
}
