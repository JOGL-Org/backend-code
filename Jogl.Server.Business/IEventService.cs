...
namespace Jogl.Server.Business
{
    public interface IEventService
    {
        ...
        ListPage<Event> ListForNode(string nodeId, string currentUserId, List<CommunityEntityType> types, List<string> communityEntityIds, bool currentUser, List<EventTag> tags, DateTime? from, DateTime? to, string search, int page, int pageSize, SortKey sortKey, bool ascending);
